...
`r NVIpkg`: Tools to facilitate the running of R-scripts in batch mode at NVI
================
...
# Overview
`r NVIpkg_inline` provide tools to facilitate the writing of batch R-scripts that
