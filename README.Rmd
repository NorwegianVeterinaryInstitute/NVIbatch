...
`r paste0(NVIpkg_inline, 
   " ", 
   sub(substr(description,1,1), tolower(substr(description,1,1)), description))` The vignette "Run R scripts automatically" gives a detailed description on how you can set up an automatic batch job to run an R script on Windows.
