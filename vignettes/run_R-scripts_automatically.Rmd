...
Give the main script a short, descriptive name. The name of the main script is included in the bat-file command and you prefer to not have to change the bat-file command. The main script for gererating outbreak report is by convention named batch_outbreak.R
