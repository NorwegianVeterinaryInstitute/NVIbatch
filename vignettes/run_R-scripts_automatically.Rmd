...
### Mark the end of the main script
At the end of the script it is useful to print a message that marks the end of the script. That is because you in the next step error messages and warnings will be checked and messages after the end-mark don't need to be checked. When finish ingen a batch Job there will often be error messages du to lack of writing access. To avoid these to turn up in the check, see next section, you mark the end of the script. There is no need for this step unless you run the check log step. 
```{r, include = TRUE} 
